...
def main(args: argparse.Namespace) -> tuple[float, float]:
    ...
    for decay in lambdas:
        y_pred = sklearn.linear_model.Ridge(alpha=decay).fit(X_train, y_train).predict(X_test)
        rmses.append(sklearn.metrics.mean_squared_error(y_test, y_pred, squared=False))
