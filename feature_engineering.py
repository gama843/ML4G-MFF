...
def main(args: argparse.Namespace) -> tuple[np.ndarray, np.ndarray]:
    ...
    categorical_transformer = sklearn.preprocessing.OneHotEncoder(handle_unknown="ignore", sparse=False)
    ...
    pipeline = sklearn.pipeline.Pipeline(
        steps=[("preprocessor", preprocessor), ("poly_f", poly_features)]
    )
